...
_Warning: It is recommended to use [`React.createContext`](https://reactjs.org/docs/context.html#reactcreatecontext) instead! It provides generally the same functionality, and Provider / inject is mostly around for legacy reasons_
