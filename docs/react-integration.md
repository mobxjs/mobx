...
<details id="wrap-order"><summary>{<span title="Advanced feature">🚀</span>} **Tip:** when combining `observer` with other higher-order-components, apply `observer` first<a href="#wrap-order" class="tip-anchor"></a></summary>
...
<details id="computed-props"><summary>{<span title="Advanced feature">🚀</span>} **Tip:** deriving computeds from props<a href="#computed-props" class="tip-anchor"></a></summary>
...
<details id="useeffect"><summary>{<span title="Advanced feature">🚀</span>} **Tip:** useEffect and observables<a href="#useeffect" class="tip-anchor"></a></summary>
...
Check out the [React optimizations {<span title="Advanced feature">🚀</span>}](react-optimizations.md) section.
