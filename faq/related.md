...
* (official) React, Babel, Webpack: https://github.com/mweststrate/react-mobservable-boilerplate
* (official) React, Typescript, Webpack: https://github.com/mobxjs/mobx-react-typescript-boilerplate  
* JSFiddle: https://jsfiddle.net/mweststrate/wgbe4guu/
* JSFiddle with just ES5: https://jsfiddle.net/rubyred/55oc981v/

## Full fledged boilerplates
...
* Form abstraction: https://jsfiddle.net/darthapo/k63ujjsp/

## Libraries

* (official) MobX-React bindings: https://github.com/mobxjs/mobx-react
* (official) Mobx-React-Devtools: https://github.com/mobxjs/mobx-react-devtools
...
* Anything missing? Feel free to add your own library / project!
