...
Installation: `npm install mobservable`
...
// Print a message whenever an observable changes:
...
var Person = function(firstName, lastName) {
    // define observable properties firstName, lastName and fullName
...
jane.fullName.observe(console.log);
jane.lastName = "Do";
// prints: "Jane Do"
```

## Example: Lists, classes and annotations
