...
# compile umd and commonjs, generate declaration, no comments
tsc -m umd      -t es5 -d --removeComments --outDir lib .build/mobservable.ts 
mv lib/mobservable.js lib/mobservable.umd.js
