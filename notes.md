...
-   [ ] docs
    ...
    -   [x] sync readme's
    -   [x] verify that MobX is by default in strict mode
    -   [x] make links for all tips
    -   [ ] cleanup notes files
    -   [x] blog post
    -   [x] fix #2457
    -   [x] don't minimize default builds
...
│ (index) │ just this │ cumulative │ increment │
├──────────────────────┼───────────┼────────────┼───────────┤
│ import \* from 'mobx' │ 15277 │ 0 │ 0 │
│ observable │ 12949 │ 12949 │ 0 │
│ computed │ 12950 │ 12965 │ 16 │
│ autorun │ 12952 │ 12982 │ 17 │
│ action │ 12950 │ 12996 │ 14 │
└──────────────────────┴───────────┴────────────┴───────────┘
(this report was generated by npmjs.com/package/import-size)
...
│ (index) │ just this │ cumulative │ increment │
├──────────────────────┼───────────┼────────────┼───────────┤
│ import \* from 'mobx' │ 16111 │ 0 │ 0 │
│ observable │ 13757 │ 13757 │ 0 │
│ computed │ 13758 │ 13773 │ 16 │
│ autorun │ 13759 │ 13787 │ 14 │
│ action │ 13758 │ 13800 │ 13 │
└──────────────────────┴───────────┴────────────┴───────────┘
(this report was generated by npmjs.com/package/import-size)
