...
test("deepEquals should yield correct results for complex objects #1118 - 1", () => {
    ...
    expect(mobx.deepEqual(d2016jan1, d2016jan1)).toBe(true)
    expect(mobx.deepEqual(d2016jan1, d2017jan1)).toBe(false)
    expect(mobx.deepEqual(d2016jan1, d2016jan1_2)).toBe(true)
})
...
test("deepEquals should yield correct results for complex objects #1118 - 2", () => {
    ...
    expect(mobx.deepEqual(a1, a1)).toBe(true)
    expect(mobx.deepEqual(a1, a3)).toBe(false)
    expect(mobx.deepEqual(a1, a2)).toBe(true)
    expect(mobx.deepEqual(a1, a4)).toBe(false)
})
