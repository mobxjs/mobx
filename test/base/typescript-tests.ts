...
test.skip("wtf", () => {
    ...
    var A /** @class */ = (function() {
        ...
        __decorate([action], A.prototype, "method", null)
        return A
    })()
    var B /** @class */ = (function(_super) {
        ...
        __decorate([action], B.prototype, "method", null)
        return B
    })(A)
    var C /** @class */ = (function(_super) {
        ...
        __decorate([action], C.prototype, "method", null)
        return C
    })(B)
    var b = new B()
    console.log(b.method(), 84)
    var a = new A()
    console.log(a.method(), 42)
    var c = new C()
    console.log(c.method(), 87)
    function action(target, prop, descriptor) {
