import { invariant } from "../../mobx-core"
...
export var action: IActionFactory = function action(arg1, arg2?, arg3?, arg4?): any {
	if (arguments.length === 1 && typeof arg1 === "function")
		return createAction(mobxState, arg1.name || "<unnamed action>", arg1)
	if (arguments.length === 2 && typeof arg2 === "function")
		return createAction(mobxState, arg1, arg2)
...
action.bound = function boundAction(arg1, arg2?, arg3?) {
	if (typeof arg1 === "function") {
		const action = createAction(mobxState, "<not yet bound action>", arg1)
...
function namedActionDecorator(name: string) {
	return function(target, prop, descriptor) {
		if (descriptor && typeof descriptor.value === "function") {
			...
			descriptor.value = createAction(mobxState, name, descriptor.value)
...
export function defineBoundAction(target: any, propertyName: string, fn: Function) {
	const res = function() {
		return executeAction(mobxState, propertyName, fn, target, arguments)
	}
