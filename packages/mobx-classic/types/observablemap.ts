...
import { isES6Map, getMapLikeKeys } from "../utils/utils"
import {
	IInterceptable,
	IInterceptor,
	hasInterceptors,
...
export class ObservableMap<V>
	...
	constructor(
		...
		public name = "ObservableMap@" + mobxState.nextId()
	) {
	...
	set(key: string, value?: V | undefined) {
		...
		if (hasInterceptors(this)) {
			const change = interceptChange<IMapWillChange<V>>(mobxState, this, {
